...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'iFormer training and evaluation script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='iFormer_m', type=str, metavar='MODEL',
                        choices=['iFormer_s', 'iFormer_h', 'iFormer_l', 'iFormer_m',
    ...
    # Finetuning params
    parser.add_argument('--finetune', default='./iFormer_m.pth',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'iFormer training and evaluation script', parents=[get_args_parser()])
